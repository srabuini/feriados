...
module Feriados
  module Argentina
    ...
    Feriados.add 'Paso a la Inmortalidad del General Manuel Belgrano', dia: 20,
     mes: 6
    ...
    Feriados.add 'Paso a la Inmortalidad del General José de San Martín',
     dia: 17, mes: 8, cambia_fijo: [:tercer, :lunes]
    Feriados.add 'Día del Respeto a la Diversidad Cultural', dia: 12, mes: 10,
     cambia_fijo: [:segundo, :lunes]
    Feriados.add 'Día de la Soberanía Nacional', dia: 20, mes: 11,
     cambia_fijo: [:cuarto, :lunes]

    # Feriados especiales 2012
    Feriados.add "Día del Bicentenario de la Creación y Primera Jura de la \
      Bandera Argentina", dia: 27, mes: 2, anio: 2012
    Feriados.add "Día del Bicentenario de la Batalla de Tucumán", dia: 24,
     mes: 9, anio: 2012
    ...
    Feriados.add "Feriado puente", dia: 2, mes: 5, anio: 2014
    Feriados.add "Feriado puente", dia: 26, mes: 12, anio: 2014

    # Feriados especiales 2015
    Feriados.add "Feriado puente", dia: 23, mes: 3, anio: 2015
    Feriados.add "Feriado puente", dia: 7, mes: 12, anio: 2015

    # Feriados especiales 2016
    Feriados.add "Feriado puente", dia: 8, mes: 7, anio: 2016
    Feriados.add "Feriado puente", dia: 9, mes: 12, anio: 2016
  end
end
